...
PC12a_filename <- paste(path,
                        "fOTU_max_PC1-and-2_x--100-to-0-and-y--100-to-+100.txt", 
                        sep = "", 
                        collapse = NULL)
PC12b_filename <- paste(path,
                        "fOTU_max_PC1-and-2_x-+250-to-+400-and-y--100-to-0.txt", 
                        sep = "", 
                        collapse = NULL)
PC23_filename <- paste(path,
                       "fOTU_max_PC2-and-3_x--100-to-+50-and-y--100-to-+100.txt", 
                       sep = "", 
                       collapse = NULL)
PC34_filename <- paste(path,
                       "fOTU_max_PC3-and-4_x--50-to-+50-and-y--50-to-+75.txt", 
                       sep = "", 
                       collapse = NULL)
```
