...
fOTUsHMM <- read_csv(file = "../analyses/HMMsearch/fOTUsHMM.csv")
```
...
```{r}
file_name <- "../visualisations/ggbiplot_max_PC1-2.png"
...
ggsave(filename = "../visualisations/pca_hmmsearch_max_PC1-2.png",
       device = png, 
       width = 1000, 
       height = 750, 
       units = "in",
...
ggsave(filename = "../visualisations/pca_hmmsearch_max_PC2-3.png",
       device = png, 
       width = 1000, 
       height = 750, 
       units = "in",
...
ggsave(filename = "../visualisations/pca_hmmsearch_max_PC3-4.png",
       device = png, 
       width = 1000, 
       height = 750, 
       units = "in",
...
file_name <- "../visualisations/heatmap_max_20_first_PCs.png"
png(filename = file_name)
heatmap(as.matrix(prediction))
dev.off()
heatmap(as.matrix(prediction))

file_name <- "../visualisations/heatmap_max_400_first_fOTUs.png"
png(filename = file_name)
...
path <- "../visualisations/nmds_hmmsearch_max_MDS1_less_than_50.png"
