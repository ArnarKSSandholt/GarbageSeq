...
```{r}
file_name <- "../visualisations/ggbiplot_avg_PC1-2.png"
...
file_name <- "../visualisations/heatmap_avg_20_first_PCs.png"
png(filename = file_name)
heatmap(as.matrix(prediction))
dev.off()
heatmap(as.matrix(prediction))

file_name <- "../visualisations/heatmap_avg_400_first_fOTUs.png"
png(filename = file_name)
