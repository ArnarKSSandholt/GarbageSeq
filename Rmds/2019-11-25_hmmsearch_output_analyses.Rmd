...
#saveRDS(fOTUsHMM, file = "../analyses/HMMsearch/temp_R_data/fOTUsHMM.rds")
fOTUsHMM <- readRDS(file = "../analyses/HMMsearch/temp_R_data/fOTUsHMM.rds")
```
...
path <- "../visualisations/HMMsearch/nmds_hmmsearch_avg_MDS1_less_than_50.png"
...
path <- "../visualisations/HMMsearch/nmds_hmmsearch_avg_MDS1_less_than_1_and_greater_than_-1.png"
