...
for TAXID in $DATA*/ ; do
  ...
  for HMM in "${HMMs[@]}"; do
    ...
    for fOTUproteom in "${fOTUproteoms[@]}"; do
      ...
      #echo "$HMMer_OUTPUT_DIR""$TAXID_NO""-with-""$HMM_VARIANT""-in-""$fOTU"".pfamtbl.out" >> hmmruns.csv
      ...
      #hmmsearch --cpu 10 --noali -E 0.1 --domE 0.1 --incE 0.001 --incdomE 0.001 --notextw --pfamtblout "$HMMer_OUTPUT_DIR""$TAXID_NO""-with-""$HMM_VARIANT""-in-""$fOTU"".pfamtbl.out" "$HMM" "$fOTUproteom"
