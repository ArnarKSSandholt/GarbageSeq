...
grep -E 'Viruses' "$ANNOT"*.emapper.annotations > "$ANALYSES"viruses.emapper.annotations
head -n 2 "$ANALYSES"viruses.emapper.annotations
```
...
awk '{print $5}' "$ANALYSES"viruses.emapper.annotations | sort | uniq
```
